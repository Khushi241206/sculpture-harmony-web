...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sculpture — Duplex Living & Shops" },
      { property: "og:description", content: "Modern bungalow-style duplex homes in Ognaj, Ahmedabad. Possession Oct 2027." },
